...
public class RentListServlet extends HttpServlet {
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /**
         * 登陆成功后就已经跳转到 RentListServlet 类查询并展现全部了
        ...
        System.out.println("日志: RentListServlet total = "+total);
        ...
        List<Rent> list = dao.findRentAll(start,end,field,keyword);
        System.out.println("日志 RentListServlet   doPost() list = "+list);
